...
#define KMOD_REQ_TRACE_CONTEXT_START CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0300, METHOD_IN_DIRECT, FILE_SPECIAL_ACCESS)
#define KMOD_REQ_TRACE_CONTEXT_END   CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0301, METHOD_IN_DIRECT, FILE_SPECIAL_ACCESS)
