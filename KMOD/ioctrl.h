...
#define KM_SCAN_INT_32           CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0502, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define KM_SCAN_REAL_32          CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0503, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
...
typedef struct _SCAN_INT_32
{

} SCAN_INT_32, * PSCAN_INT_32;
typedef struct _SCAN_REAL_32
{

} SCAN_REAL_32, * PSCAN_REAL_32;
