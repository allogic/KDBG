...
#define KDRV_CTRL_SCAN_MEMORY_REQEUST CTL_CODE(FILE_DEVICE_UNKNOWN, 0x0500, METHOD_IN_DIRECT, FILE_SPECIAL_ACCESS)
...
typedef struct _KDRV_SCAN_MEMORY_REQUEST
{
  ULONG Pid;
  ULONG DataType;
  PBYTE Pattern;
} KDRV_SCAN_MEMORY_REQUEST, * PKDRV_SCAN_MEMORY_REQUEST;
